...
**Function:** Sales Enablement  ·  **Integrations:** call_recorder, communication  ·  **Template id:** `AGTSkillCoach01`

> Provides personalized coaching recommendations based on conversation analysis and performance gaps.

## When it fires

**Detector:** Trigger if the user wants personalized coaching recommendations for sales reps based on conversation analysis and skill gaps.

**Signal keywords:** `coaching`, `rep coaching`, `skill development`, `sales training`, `coaching recommendation`, `performance coaching`, `skill gaps`, `training`

## What it does

Analyze sales conversations to identify coaching opportunities. Evaluate discovery skills, presentation skills, objection handling, and relationship building. Provide weekly coaching alerts to managers.
...
---
_From GTM Superintelligence agent templates. Raw definition: [`skill-coach.json`](./skill-coach.json)._
