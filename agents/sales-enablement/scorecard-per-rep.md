...
**Function:** Sales Enablement  ·  **Integrations:** call_recorder, communication  ·  **Template id:** `AGTScorecardRep01`

> Generates performance scorecards for sales reps based on conversation quality, activity metrics, and deal progression.

## When it fires

**Detector:** Trigger if the user wants to generate performance scorecards, analytics, or coaching reports for individual sales reps based on conversation quality.

**Signal keywords:** `rep scorecard`, `performance scorecard`, `rep performance`, `sales metrics`, `rep analytics`, `performance report`, `rep evaluation`, `sales performance`

## What it does

Analyze rep performance across conversation quality, activity metrics, deal management, and customer relationships. Generate monthly scorecards with coaching recommendations.
...
---
_From GTM Superintelligence agent templates. Raw definition: [`scorecard-per-rep.json`](./scorecard-per-rep.json)._
