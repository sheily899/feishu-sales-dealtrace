...
**Function:** Account Management  ·  **Integrations:** crm, call_recorder, communication  ·  **Template id:** `AGTRiskWatch01`

> Monitors accounts for risk indicators including negative sentiment, engagement drops, and unresolved issues.

## When it fires

**Detector:** Trigger if the user wants to monitor accounts for risk indicators like declining engagement, negative sentiment, or unresolved issues.

**Signal keywords:** `account risk`, `customer risk`, `risk indicator`, `engagement drop`, `risk alert`, `account health`, `declining engagement`, `customer health score`

## What it does

Continuously monitor customer accounts for risk indicators: declining engagement, negative sentiment, usage challenges, relationship risks, and competitive threats. Send tiered alerts.
...
---
_From GTM Superintelligence agent templates. Raw definition: [`risk-watch.json`](./risk-watch.json)._
