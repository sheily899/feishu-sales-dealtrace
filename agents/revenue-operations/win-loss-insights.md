...
**Function:** Revenue Operations  ·  **Integrations:** crm, call_recorder, communication  ·  **Template id:** `AGTWinLossIns01`

> Analyzes won and lost deals to identify patterns, competitive dynamics, and key factors influencing outcomes.

## When it fires

**Detector:** Trigger if the user wants to analyze patterns in won and lost deals to understand success factors, failure reasons, and competitive dynamics.

**Signal keywords:** `win loss`, `won deals`, `lost deals`, `win rate`, `deal analysis`, `win loss analysis`, `why we won`, `why we lost`, `deal patterns`

## What it does

Analyze closed deals (won and lost) to extract strategic insights, competitive intelligence, and success patterns. Generate monthly reports with recommendations.
...
---
_From GTM Superintelligence agent templates. Raw definition: [`win-loss-insights.json`](./win-loss-insights.json)._
