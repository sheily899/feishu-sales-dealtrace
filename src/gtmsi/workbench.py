...
<main><header><div><p class="eyebrow">SALES INTELLIGENCE</p><h1 id="name">加载中…</h1><p id="meta" class="muted"></p></div><button id="go">生成分析</button></header><section class="workspace"><aside><h2>群聊记录</h2><div id="messages"></div></aside><article><p class="eyebrow">AI ANALYSIS</p><h2>销售沟通分析</h2><p id="status" class="muted">待分析</p><div id="report" class="muted">点击“生成分析”，由 DeepSeek 基于群聊生成客户沟通分析报告。</div></article></section></main>
<script>
let state;
